...
const { getCreateAcount, getLogIn, postCreateAcount, postLogIn, logOut } = require("../controlador/authentication");
authentication.get("/crearCuenta", getCreateAcount);
authentication.get("/login", getLogIn);
authentication.get("/logout", logOut);
authentication.post("/crearCuenta", passport.authenticate("crearCuenta", { passReqToCallback: true, failureRedirect: "/perfil/crearCuenta" }), postCreateAcount);
