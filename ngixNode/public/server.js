...
function encenderServer() {
  ...
  app.get("/productos", checkAuthentication, routes.getProductsRout);
  //PRODUCTOS FAKER
  app.get("/productos-test", checkAuthentication, routes.productsTest);
  ////
  app.get("/api/productos", routes.getApiProductos);
  /////////////////////////////////////////////Crear Cuenta
