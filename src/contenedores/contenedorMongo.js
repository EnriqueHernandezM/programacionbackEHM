...
const Usuarios = require("../models/usuario.js").default;
...
class ContenedorMongo {
  ...
  connectMG = async () => {
    try {
      await connect("mongodb+srv://enriquehm:0h47RMcEkqCLHjTP@cluster0.ckqspop.mongodb.net/?retryWrites=true&w=majority");
    } catch (e) {
      console.log(e);
